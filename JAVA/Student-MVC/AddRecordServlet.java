 ...
 * @author HP
 */
@WebServlet(urlPatterns = {"/addRecordServlet"})
public class AddRecordServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String s_city=request.getParameter("student_city");
            
            Student student=new Student();
            student.setRoll_no(s_rollno);
            student.setName(s_name);
            student.setAddress(s_address);
            student.setCity(s_city);
            ...
            out.println("</head>");
            out.println("<body>");
            if(studentdao.insertRecord(student)!=0){
