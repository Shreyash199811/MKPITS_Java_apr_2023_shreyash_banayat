...
//    }
    ...
    @GetMapping("/display")
    public String display(@PageableDefault Pageable pageable, Model model){
        Page<Student> listStudent=studentServiceImp.findPaginated(pageable);
        model.addAttribute("page",listStudent);
        return "displayData";
    }


    @PostMapping("/insert")
    public String insertData(@ModelAttribute("stud") Student theStudent){
